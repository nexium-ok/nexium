<script lang="ts">
	...
	import { HomeIcon, UsersIcon, BookOpenIcon, PlusCircleIcon, EditIcon, FilePlusIcon, CopyIcon, FolderPlusIcon, RefreshCcwIcon, UploadCloudIcon, CheckSquareIcon, SunriseIcon, FlagIcon,StarIcon, BookIcon, PhoneIcon, ActivityIcon, TabletIcon, TargetIcon, TerminalIcon, TagIcon } from "svelte-feather-icons";
		...
		<div class="position-sticky pt-3">
			...
			<ul class="nav flex-column">
				...
				<li class="nav-item mt-2 d-md-none d-block">
					<a class="nav-link" href="/">Back to Nexrev</a>
				</li>
			</ul>
		</div>
	</nav>
