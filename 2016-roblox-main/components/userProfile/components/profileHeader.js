...
import RapStatistic from "./rapStatistic";
import { getTotalRap } from "../../../services/inventory";
  ...
  useEffect(() => {
    ...
    getMembershipType({userId: store.userId}).then(d => {
      ...
      // can fail when not logged in :(
        ...
        getTotalRap({userId: store.userId}).then(d => {
      setRap(d);
    }).catch(e => {
          ...
          <div className='row'>
            ...
            <div className='col-12 col-lg-10 ps-0'>
              ...
              <div className='row'>
                ...
                <RapStatistic value={rap} userId={store.userId}/>
                {
                  showButtons && <>
