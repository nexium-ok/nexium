...
Roblox.Configuration.RobloxOpenCloudApiKey = configuration.GetSection("RobloxOpenCloudApiKey").Value;
...
Roblox.Website.Filters.StaffFilter.Configure(configuration.GetSection("OwnerUserId").Value.Split(',').Select(s => long.Parse(s.Trim())));
