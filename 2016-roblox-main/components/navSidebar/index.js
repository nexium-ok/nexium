...
const NavSideBar = props => {
  ...
  return <div className={s.container}>
    <div className={s.card} style={{ paddingTop: paddingTop }}>
      ...
      <LinkEntry name='Avatar' url='/My/Character.aspx' icon='icon-nav-charactercustomizer' />
      ...
      <LinkEntry name='Forums' url='/Forum/Default.aspx' icon='icon-nav-forum' />
       <LinkEntry name='Promocodes' url='/internal/promocodes' icon='icon-nav-shop' />
      {authStore.isAdmin && (
        <LinkEntry name='Admins' url='/admin' icon='icon-nav-group' />
      )}
      <a href='/BuildersClub/Upgrade.ashx'><p className={s.upgradeNowButton}>Upgrade Membership</p></a>
    </div>
  </div>
}
