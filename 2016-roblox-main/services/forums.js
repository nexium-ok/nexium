...
const ForumsCategories = [
  {
    ...
    subCategories: [
      {
        id: 46,
        name: 'All Things Nexrev',
        description:
          'The area for discussions purely about Nexrev – the features, the games, and company news.',
      },
      {
        id: 14,
      ...
      },
      {
        ...
        description:
          'Do you have a suggestion and ideas for Nexrev? Share your feedback here.',
      },
      {
        id: 54,
        name: 'Nexrev events',
        description:
          'Check here to see the crazy things Nexrev is doing. Discuss those events here!',
      },
    ],
  },
  {
    ...
    subCategories: [
      {
        ...
        name: 'Nexrev Talk',
        description:
          'A popular hangout where Nexrev players talk about various topics.',
      },
      {
        id: 18,
        name: 'Off Topic',
      ...
      },
      {
        ...
        description:
          'A fast paced community dedicated to mastering the Limited Trades and Sales market, and divining the subtleties of the Nexrev Currency Exchange.',
      },
    ],
  },
];
