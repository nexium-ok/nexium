<script lang="ts">
	...
	function deleteAsset() {
		if (!confirm(`Are you sure you want to permanently delete "${assetDetails.name}"? This cannot be undone.`)) {
			return;
		}

		disabled = true;
		request
			.delete("/asset/delete?assetId=" + assetId)
			.then(() => {
			...
			<div class="col-12 mt-4">
				...
				<div class="row">
					...
					<div class="col-12 mt-2">
						...
						<Permission p="DeleteCatalogAsset">
							<button
