...
const AccountInfo = props => {
  ...
  const editButtonStyles = useEditButtonStyles();
  return <div className='row'>
    <div className='col-12 mt-2'>
      ...
      <div className={cardStyles.card + ' p-3'}>
        ...
        <p className={s.accountInfoLabel}>2FA: <span className={s.accountInfoValue}>{store.twoFactorEnabled ? 'Enabled' : 'Not enabled'}</span> {store.twoFactorEnabled === true &&
          <span className={editButtonStyles.infoText}>To disable 2FA on your account, make a ticket in the discord server</span>
        } {store.twoFactorEnabled === false &&
          <a className={editButtonStyles.editButton} href={store.twoFactorSetupUrl}>Set up 2FA</a>
        }</p>
      </div>
    </div>
    <div className='col-12 mt-2'>
      ...
      <div className={cardStyles.card + ' p-3'}>
        ...
        <p className='mb-0 font-size-12'>Do not provide any details that can be used to identify you outside Nexrev.</p>
        <div className='mt-1'>
          <div className='row'>
