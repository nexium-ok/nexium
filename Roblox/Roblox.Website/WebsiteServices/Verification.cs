...
/// <returns></returns>
/// <exception cref="InvalidSocialMediaUrlException">Social media URL is invalid or not a supported Roblox URL</exception>
...
public async Task<VerificationResult> AttemptVerifyUser(string? socialUrl, string verificationPhrase)
{
    ...
    if (socialData == null || socialData.site != SocialMediaSite.RobloxUserId)
    ...
    var isUnderageUser = socialUrl != null && socialUrl.Contains("web.roblox.com");
    ...
    return new VerificationResult()
    {
        ...
        normalizedUrl = socialUrl ?? string.Empty,
