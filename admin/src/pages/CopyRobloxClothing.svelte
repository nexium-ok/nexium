		...
		<div class="col-6 mt-4">
			<button
				...
				on:click={(e) => {
					...
					const isBundle = url.includes('/bundles/');
					const id = parseInt(url.match(/[0-9]+/)[0], 10);
					const req = isBundle
						? request.post("/bundle/copy-from-roblox?bundleId=" + id, {})
						: request.post("/asset/copy-from-roblox", {
								assetId: id,
