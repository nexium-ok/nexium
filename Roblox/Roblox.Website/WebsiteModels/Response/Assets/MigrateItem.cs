...
public class MigrateItem
{
        ...
        int? price = null, IEnumerable<Models.Assets.Type>? allowedTypes = null, ProductDataResponse? defaultResponse = null, bool doRender = true, bool autoApprove = false)
    {
        ...
        else
        {
            ...
            {
                content = await robloxApi.GetAssetContent(assetId, Roblox.Configuration.RobloxOpenCloudApiKey);
            }
        ...
        if (contentId != null)
        {
            var imageData = await robloxApi.GetAssetContent((long) contentId, Roblox.Configuration.RobloxOpenCloudApiKey);
